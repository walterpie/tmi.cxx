...
void tmi_promise_set_userdata(TmiPromise *promise, void *userdata) {
    ((TmixxPromise *) promise)->set_userdata(userdata);
}

void *tmi_promise_userdata(TmiPromise *promise) {
    return ((TmixxPromise *) promise)->get_userdata();
}
...
void TmixxPromise::set_userdata(void *userdata) {
    this->userdata = userdata;
}

void* TmixxPromise::get_userdata() {
...
TmixxPromise *TmixxPromise::and_then(and_then_t callback) {
    ...
    auto tpl = FunctionTemplate::New(this->isolate, [](auto args) -> void {
        ...
        auto result = (TmixxPromise*) promise->cb_and_then((TmiClient*) promise->client, (TmiObject*) obj, promise->userdata);
...
void TmixxPromise::or_else(or_else_t callback) {
    ...
    auto tpl = FunctionTemplate::New(this->isolate, [](auto args) -> void {
        ...
        promise->cb_or_else((TmiClient*) promise->client, (TmiObject*) obj, promise->userdata);
    }, promise_value);
    auto fn = tpl->GetFunction(this->context).ToLocalChecked();
